...
// setInterval(() => {
//     let temp=Array.from(document.getElementsByClassName("silder-box"))[8]
//     // let temp2=Array.from(document.getElementsByClassName("silder-box"))[7]
